...
def run_experiment(res_in_one_file, case_number, labeled_ratio, train_ratio, noise_ratio, weight_decay, walk_p=0.1, walk_q=10, mode="debug", baseline=False, seed=1111, epoch_times=3):
    ...
    while epoch_times:
        ...
        epoch_times -= 1
        utils.save_tofile([log_dict["actual_label"], log_dict["edge_score"]], "netgan_non_baseline_roc_curve.pkl")
...
if __name__ == '__main__':
    ...
    res_in_one_file = "task_2_labeled_ratio_%s_noise_ratio_%s_non_baseline.txt" %(str(labeled_ratio), str(noise_ratio))
