...
plt.plot(base_fpr, base_tpr, 'r--', label='Base NetGAN')
plt.plot(base_fpr_1, base_tpr_1, 'b--', label='Base CELL')
plt.plot(non_base_fpr, non_base_tpr, 'r', label='NetGAN')
plt.plot(non_base_fpr_1, non_base_tpr_1, 'b', label='CELL')
#plt.plot(x, y, linestyle='--', label='random classification')
#plt.plot(b1, b2, label='perfect classification')

plt.title('ROC curve with AR = 0.5')
